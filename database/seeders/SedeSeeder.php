...
class SedeSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('sede')->insert([
            ...
            ['nombre' => 'San Martin de los Andes (Centro Regional Universitario San Martín de los Andes - FACA)', 'id_facultad' => 17],
            ['nombre' => 'Zapala (Centro Regional Universitario Zapala - FAIN)', 'id_facultad' => 18],
        ]);
    }
}
